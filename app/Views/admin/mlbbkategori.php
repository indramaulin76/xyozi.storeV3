    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-murky-800 rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 space-y-4">
              <form action="<?= base_url('admin/mlbbkategori/tambah') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="mb-3">
                    <label for="pid" class="block mb-2 text-sm font-medium text-white">Provider ID</label>
                    <input type="text" name="pid" class="custom-input block w-full" placeholder="Masukkan Provider ID" required>
                  </div>
                 <div class="mb-3">
                    <label for="kode" class="block mb-2 text-sm font-medium text-white">Kode</label>
                    <input type="text" name="kode" class="custom-input block w-full" placeholder="Masukkan kode kategori" required>
                  </div>
                  <div class="mb-3">
                    <label for="games" class="block mb-2 text-sm font-medium text-white">Games</label>
                    <input type="text" name="games" class="custom-input block w-full" placeholder="Masukkan nama games/kategori" required>
                  </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-murky-800 rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <button onclick="window.location.href='<?= base_url('admin/mlbbkategori/hapus/' . $k['id']) ?>'" type="button" class="text-white bg-red-600 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                    Hapus
                </button>
